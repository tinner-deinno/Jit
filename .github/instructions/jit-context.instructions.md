...
|-----------|----------|------|
| **Jit** (จิต) | `/workspaces/Jit` OR `C:\Users\admin\Jit` | Mind, memory, soul, personality |
| **innova-bot** | `C:\Users\admin\DEV\PugAss1stant\innova-bot` | Body (ร่างกาย), MCP server |
...
| **mdes-hub** | `C:\Users\admin\DEV\mdes-hub` | Government Services Hub admin panel (SA: Jit, Phase 74 done) |
| **9arm-skills** | `C:\Users\admin\DEV\9arm-skills` | Engineering & Productivity skills (debug-mantra, post-mortem, scrutinize, management-talk) |

## Environment Detection

**Codespace / Linux** (`/workspaces/`):
...
**Windows** (`C:\Users\admin\Jit`):
- **Node.js**: `node` (v24+)
- **Python**: `python` (v3.14+)
- **Bash**: NOT available natively — use PowerShell or `wsl bash`
- **JIT_ROOT**: `C:\Users\admin\Jit`
- **innova-bot**: `C:\Users\admin\DEV\PugAss1stant\innova-bot`
- **Oracle Server**: `http://127.0.0.1:47778` (when running)
- **Oracle Check**: `Invoke-WebRequest -Uri "http://127.0.0.1:47778/api/health" -UseBasicParsing`
